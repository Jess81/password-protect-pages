=== Plugin Name ===
Contributors: jessn
Donate link: https://www.paypal.me/micromedia
Tags: password, login
...
Restrict access to chosen pages to only logged in users.
...
When non-logged in users try to access a password protected page they will be redirected to the WordPress login screen.  Once logged in, they will be redirected back to the requested page.
...
You can read a good explaination of how to do that here: https://digitalharpreet.com/find-wordpress-page-id/
